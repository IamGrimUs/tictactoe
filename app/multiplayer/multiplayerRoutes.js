...
router.post('/', multiplayerController.startGame) // check db for records if record exists with no playerTwo add playerTwo or if no records then create game in db
